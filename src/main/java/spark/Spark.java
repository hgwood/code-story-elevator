/**
 * This is a copy of Spark's original source file with only one difference:
 * the stop method is public. I use this so that I can write acceptance tests
 * that start and stop Spark at will.
 */
